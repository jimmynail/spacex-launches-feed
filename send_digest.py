...
def _render(items: list) -> tuple[str, str]:
    ...
    if not items:
        ...
        footer_txt = (
            ...
            f"generated by your GitHub Action (jimmynail/spacex-launches-feed).\n"
        ...
        footer_html = (
            ...
            f"This email lists upcoming SpaceX launches from Vandenberg SFB within a {WEEKS_AHEAD}-week window, "
            f"generated by your GitHub Action (jimmynail/spacex-launches-feed).<br>"
            f"Edit the look-forward window: <a href='{SCRIPT_URL}'>script</a><br>"
            f"Disable these emails: <a href='{WORKFLOW_URL}'>GitHub Actions</a>"
            f"</p>"
        )
